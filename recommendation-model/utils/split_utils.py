...
from ..configs.constants import DEFAULT_ITEM_COL, DEFAULT_USER_COL
...
def _check_min_rating_filter(filter_by, min_rating, col_user, col_item):
    if not (filter_by == "user_id" or filter_by == "product_id"):
        raise ValueError("filter_by should be either 'user' or 'product'.")
